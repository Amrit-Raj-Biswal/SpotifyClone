    ...
    <div className='w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex'>
        ...
        <div className='bg-[#121212] h-[85%] rounded'>
            ...
            <div className='p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4'>
                ...
                <p>Worry not! We'll help you through.</p>
                <button className='px-4 py-1.5 bg-white t-[15px] text-black rounded-full mt-4'>Create Playlist</button>
            </div>
            <div className='p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4'>
                <h1>Find some podcasts to follow.</h1>
                <p>We'll keep you updated!</p>
                <button className='px-4 py-1.5 bg-white t-[15px] text-black rounded-full mt-4'>Browse Podcasts</button>
            </div>
        </div>    
    </div>
  )
